#!/bin/bash
# Build script for Eighty/20 Results - E20R Promotion Banner Image Widget plugin
#
short_name="e20r-promotion-banner-images"
server="eighty20results.com"
include=(css images includes javascript languages class.${short_name}.php readme.txt)
